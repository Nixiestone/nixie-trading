...
class NixieTradingBot:
    ...
    async def initialize(self):
        ...
        try:
            ...
            print(Fore.GREEN + "[SIGNAL] Signal generator ready")
            print(Fore.GREEN + "  ✓ Duplicate signal prevention")
            print(Fore.GREEN + "  ✓ Auto CSV export")
            print(Fore.GREEN + "  ✓ TP/SL monitoring")
            ...
            for symbol in symbols:
                try:
                    ...
                    if signal:
                        ...
                        print(Fore.GREEN + f"[SIGNAL] Generated for {symbol} - {signal['direction']} {signal['entry_type']}")
    ...
    def _format_startup_message(self):
        ...
        if hasattr(self.telegram_handler, 'account_manager'):
            try:
                stats = self.telegram_handler.account_manager.get_total_accounts()
                account_info = f"""
<b>Multi-User System:</b>
- Users with accounts: {stats['total_users']}
- Total accounts: {stats['total_accounts']}
- Active accounts: {stats['enabled_accounts']}
"""
            except:
                pass
...
"""
    ...
    def _format_hourly_message(self, updates, win_rate_stats):
        ...
        message += "\n<i>No high-probability signals detected this hour.</i>"
